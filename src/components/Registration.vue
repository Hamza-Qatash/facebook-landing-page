                            ...
                            <ValidationObserver ref="form">
                                <v-row>
                                    ...
                                    <v-col cols="12" class="py-0 mb-n2">
                                        <span class="caption pe-1">{{
                                            $t("birthday")
                                        }}</span>
                                        <v-icon class="pb-1 pointer" small
                                    ...
                                    >
                                        ...
                                        >
                                            <v-select
                                                ...
                                                v-model="
                                                    registrationInfo.birthdayMonth
                                                "
                                    ...
                                    >
                                        ...
                                        >
                                            ...
                                            >
                                                ...
                                                <div
                                                    class="d-flex align-center justify-space-between ps-3 custom-radio pointer"
                                                    :class="{
                                                        'mb-2 w-100 me-2':
                                                            isMobile,
                                                        'custom-radio-error':
                                        ...
                                        >
                                            ...
                                            >
                                                <v-select
                                                    ...
                                                    item-value="value"
                                                    v-model="
                                                        registrationInfo.customGenderPronoun
                                                    "
                                                    name="custom-gender"
                                                    :placeholder="
                                                        $t(
                                                            'custom-gender-placeholder'
                                                        )
                                                    "
                                                    required
                                                    outlined
...
export default {
    ...
    data: () => ({
        ...
        customGenders: [
            {
                value: "her",
                title_ar: 'هي: "أرسل إليها تهنئة بعيد ميلاد سعيد!"',
                title_en: 'She: "Wish her a happy birthday!"',
            },
            {
                value: "him",
                title_ar: 'هو: "أرسل إليه تهنئة بعيد ميلاد سعيد!"',
                title_en: 'He: "Wish him a happy birthday!"',
            },
            {
                value: "them",
                title_ar: 'محايد: "أرسل إليه تهنئة بعيد ميلاد سعيد!"',
                title_en: 'They: "Wish them a happy birthday!"',
            },
        ],
    }),
    computed: {
        ...
        isCustomGender() {
            return this.registrationInfo.gender === "Custom" ? true : false;
        },
        lang() {
